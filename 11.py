...
def grab_four(in_data=[['']], nr=0, nc=0, n=4):
    temp = []
    for line in in_data[nr:nr+n]:
        temp.append(line[nc:nc+n])
    return temp



def evaluate_four_grid(in_data=[['']],n = 4):
    highest_product = 0
    ...
    temp = in_data[0][0] * in_data[1][1] * in_data[2][2] * in_data[3][3]
    if temp > highest_product:
        highest_product = temp
    # calculate diagonal 2
    temp = in_data[0][3] * in_data[1][2] * in_data[2][1] * in_data[3][0]
    if temp > highest_product:
        highest_product = temp
